...
export function BlogHero() {
  const stats = [
    ...
    { label: 'Expert Contributors', value: '50+', icon: Award },
    { label: 'Topics Covered', value: '20+', icon: Globe }
  ]
    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Discover the latest insights, research breakthroughs, and industry trends 
            in laboratory management and AI technology. Stay ahead of the curve with 
