...
export default function DueCalibrationsPage() {
  const [dueCalibrations, setDueCalibrations] = useState<DueCalibration[]>([])
  ...
  const filteredCalibrations = dueCalibrations.filter(calibration => {
    ...
    const matchesTimeframe = calibration.daysUntilDue <= parseInt(timeframeFilter)
    
    return matchesSearch && matchesPriority && matchesType && matchesTimeframe
  })

  const highPriorityCount = dueCalibrations.filter(c => c.priority === 'HIGH').length
  const totalDueCount = dueCalibrations.length
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Due Soon Calibrations</h1>
              <p className="text-gray-600 mt-2">
                {totalDueCount} calibrations due within the next 30 days
              </p>
            </div>
            <Link
              ...
              <div className="flex">
                ...
                <div>
                  <h3 className="text-sm font-medium text-yellow-800">
                    {highPriorityCount} High Priority Calibrations Due Soon
                  </h3>
                  <p className="text-sm text-yellow-700 mt-1">
                    These calibrations should be scheduled and performed soon to maintain compliance.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="p-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <div className={`text-sm font-medium ${getDaysColor(calibration.daysUntilDue)}`}>
                    {calibration.daysUntilDue} days
                  </div>
                </div>
              </div>
        ...
        {filteredCalibrations.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">
              {searchTerm || priorityFilter !== 'all' || typeFilter !== 'all' || timeframeFilter !== '30'
                ? 'No calibrations match your filters'
            ...
            <p className="text-gray-600 mb-6">
              {searchTerm || priorityFilter !== 'all' || typeFilter !== 'all' || timeframeFilter !== '30'
                ...
                : 'All calibrations are scheduled for later dates!'
              }
            </p>
            {(searchTerm || priorityFilter !== 'all' || typeFilter !== 'all' || timeframeFilter !== '30') && (
              <button
