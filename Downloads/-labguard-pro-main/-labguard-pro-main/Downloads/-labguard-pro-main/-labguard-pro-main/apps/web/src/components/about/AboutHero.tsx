      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-sm font-medium">About LabGuard Pro</span>
          </motion.div>
          ...
          >
            We're on a mission to transform how laboratories operate worldwide. 
            By combining cutting-edge AI technology with deep scientific expertise, 
            we're making research faster, more accurate, and more accessible than ever before.
          </motion.p>
