...
export async function POST(request: NextRequest) {
  ...
  console.log(`🚀 [${requestId}] Verify email request started`)
  ...
  try {
    ...
    console.log(`📤 [${requestId}] Proxying to backend: ${backendUrl}/api/auth/verify-email`)

    // Get the request body
    const body = await request.json()
    console.log(`📝 [${requestId}] Verify email data:`, {
      hasToken: !!body.token
    })
    ...
    console.error(`❌ [${requestId}] Verify email proxy error:`, {
