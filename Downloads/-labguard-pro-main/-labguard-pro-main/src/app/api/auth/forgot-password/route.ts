...
export async function POST(request: NextRequest) {
  ...
  console.log(`🚀 [${requestId}] Forgot password request started`)
  ...
  try {
    ...
    console.log(`📤 [${requestId}] Proxying to backend: ${backendUrl}/api/auth/forgot-password`)

    // Get the request body
    const body = await request.json()
    console.log(`📝 [${requestId}] Forgot password data:`, {
      email: body.email
    })
    ...
    console.error(`❌ [${requestId}] Forgot password proxy error:`, {
