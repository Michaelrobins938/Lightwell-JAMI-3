...
export function BiotechnologyHero() {
  const stats = [
    { label: 'Research Speed', value: '3x Faster', icon: Clock },
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-sm font-medium">Biotechnology Solutions</span>
          </motion.div>
          ...
          >
            Accelerate biotechnology research with AI-powered experimental design, 
            automated workflows, and advanced analytics. Make breakthrough discoveries 
