    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Join our mission to revolutionize laboratory management with AI-powered technology. 
            Work with brilliant minds, solve complex challenges, and make a real impact on 
